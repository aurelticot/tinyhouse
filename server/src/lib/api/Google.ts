...
const parseAddress = (
  addressComponents: AddressComponent<any>[]
): { country: string | null; admin: string | null; city: string | null } => {
  let country = null;
  let admin = null;
  let city = null;
...
export const Google = {
  ...
  geocode: async (address: string): Promise<{ country: string | null; admin: string | null; city: string | null }> => {
