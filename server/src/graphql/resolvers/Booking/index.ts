...
import { User, Booking, Listing, Database, BookingsIndex } from "../../../lib/types";
  ...
  Mutation: {
    createBooking: async (
      ...
      try {
        ...
        // verify a logged in user is making the booking
        ...
        // create a bookingsIndex for listing being booked
        ...
        // create Stripe check on behalf of host
